...
-- -----------------------------------------------------
-- Table `mydb`.`service_list`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`service_list` (
...
-- -----------------------------------------------------
-- Table `mydb`.`price_list`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`price_list` (
  ...
  CONSTRAINT `price_list_fk_1`
    ...
    REFERENCES `mydb`.`service_list` (`slist_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `mydb`.`requirements_list`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`requirements_list` (
...
-- -----------------------------------------------------
-- Table `mydb`.`requirements_per_service`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`requirements_per_service` (
  ...
  CONSTRAINT `requirements_fk_2`
    ...
    REFERENCES `mydb`.`requirements_list` (`rlist_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `mydb`.`requirements_per_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`requirements_per_user` (
  ...
  CONSTRAINT `requirements_per_user_fk_2`
    FOREIGN KEY (`rps_id`)
    REFERENCES `mydb`.`requirements_per_service` (`rps_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
