...
CREATE TABLE IF NOT EXISTS `rba-db`.`user` (
  ...
  `user_midname` VARCHAR(25) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NULL DEFAULT NULL,
  ...
  `user_city` VARCHAR(25) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
