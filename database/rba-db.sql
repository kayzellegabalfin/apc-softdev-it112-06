...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2015 at 04:47 AM
...
--
ALTER TABLE `price_list`
ADD CONSTRAINT `price_list_fk_1` FOREIGN KEY (`plist_id`) REFERENCES `service_list` (`slist_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `requirements`
--
ALTER TABLE `requirements`
ADD CONSTRAINT `requirements_fk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `requirements_fk_2` FOREIGN KEY (`slist_id`) REFERENCES `service_list` (`slist_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `requirements_fk_3` FOREIGN KEY (`rlist_id`) REFERENCES `requirements_list` (`rlist_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `services`
--
ALTER TABLE `services`
ADD CONSTRAINT `services_fk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
