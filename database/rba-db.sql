...
-- Schema rba-db
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `rba-db` DEFAULT CHARACTER SET utf8 ;
USE `rba-db` ;
...
CREATE TABLE IF NOT EXISTS `rba-db`.`user` (
  ...
  `user_midname` VARCHAR(10) NULL DEFAULT NULL,
  `user_housenum` VARCHAR(25) NULL DEFAULT NULL,
  `user_street` VARCHAR(25) NULL DEFAULT NULL,
  `user_city` VARCHAR(25) NULL DEFAULT NULL,
  `user_country` VARCHAR(25) NOT NULL,
  `user_postalcode` INT(10) NOT NULL,
  `user_gender` VARCHAR(6) NULL DEFAULT NULL,
  `user_companyname` VARCHAR(45) NULL DEFAULT NULL,
  `user_companyadd` VARCHAR(45) NULL DEFAULT NULL,
  `user_companycontact` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `rba-db`.`requirements_per_user` (
  `rpu_id` INT NOT NULL AUTO_INCREMENT,
  `rpu_status` VARCHAR(50) NOT NULL DEFAULT 'no file submitted',
  `rpu_datefilesubmitted` TIMESTAMP NULL,
  `rpu_fileuploaded` VARCHAR(255) NULL,
  `user_id` INT(11) NOT NULL,
  `rps_id` INT(11) NOT NULL,
  PRIMARY KEY (`rpu_id`),
